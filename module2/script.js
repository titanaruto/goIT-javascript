...
// Используйте цикл for или for...of. После чего вывести alert с текстом 'Общая сумма чисел равна <сумма>'
// 🔔 Делать проверку того, что пользователь ввел именно число, а не произвольный набор символов, 
// не обязательно. Если хотите, в случае некорректного ввода, покажите alert с текстом 'Было введено не число, попробуйте еще раз', 
